package ru.connect.messenger.core.exception.handler;
...
import ru.connect.messenger.core.exception.ConflictException;
import ru.connect.messenger.core.exception.EmailAlreadyExistsException;
import ru.connect.messenger.core.exception.IllegalActionException;
import ru.connect.messenger.core.exception.InvitationIsNotValidException;
import ru.connect.messenger.core.exception.ResourceAlreadyExistsException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationErrors(MethodArgumentNotValidException ex) {
        ...
        response.put("messaging", "Ошибка валидации данных");
    ...
    public ResponseEntity<Map<String, String>> handleIllegalAction() {
        return ResponseEntity
                ...
                .body(Map.of(
                        "error", "Unauthorized",
                        "messaging", "Неверный логин или пароль"
                ));
    }
    ...
    public ResponseEntity<Map<String, String>> handleInvitationIsNotValidException() {
        return ResponseEntity
                ...
                .body(Map.of(
                        ...
                        "messaging", "Ошибка валидации данных"
                ));
    }
}
